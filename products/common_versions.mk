...
PRODUCT_BUILD_PROP_OVERRIDES += BUILD_DISPLAY_ID=r0.1
...
ifdef CYANOGEN_NIGHTLY
    ...
    ifdef CYANOGEN_RELEASE
        ...
        CMVERSION := CyanogenMod-$(PRODUCT_VERSION_MAJOR).$(PRODUCT_VERSION_MINOR).$(PRODUCT_VERSION_MAINTENANCE)$(PRODUCT_VERSION_DEVICE_SPECIFIC)1.0
    endif
endif
